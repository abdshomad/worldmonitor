    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <div class="header" role="banner">
        ...
        return `
          ...
          <span class="logo">COMMAND CENTER</span><span class="logo-mobile">Intelligent Command Center</span><span class="version">v${__APP_VERSION__}</span>
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        <div class="mobile-menu-header">
          <span class="mobile-menu-title">COMMAND CENTER</span>
        ...
        ${(() => {
        const variants = [
          { key: 'indonesia', icon: '🇮🇩', label: 'Indonesia' },
