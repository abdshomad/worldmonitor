...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Intelligent Command Center - Real-Time Global Intelligence Dashboard',
    ...
    siteName: 'Intelligent Command Center',
    shortName: 'CommandCenter',
  ...
  indonesia: {
    title: 'Indonesia Monitor - Real-Time Command Center',
    description: 'Real-time Indonesian intelligence platform tracking geopolitical signals, natural disasters, national security, maritime chokepoints, markets, and regional context in one view.',
    keywords: 'indonesia command center, indonesia intelligence, nusantara monitor, ihsg tracker, bmkg earthquake alerts, malacca strait, sunda strait, alki, natuna sea, indonesia news, antara, kompas, tempo, detik',
    url: 'https://indonesia.worldmonitor.app/dashboard',
    siteName: 'Indonesia Monitor',
    shortName: 'IndonesiaMonitor',
    subject: 'Indonesian Geopolitics, Maritime Security, and Situation Awareness',
    classification: 'National Command Center, OSINT Tool, News Aggregator',
    categories: ['news', 'productivity'],
    features: [
      'Indonesian news aggregation (Antara, Kompas, Tempo, Detik, CNBC)',
      'BMKG disaster & seismic activity alerts',
      'ALKI & maritime chokepoint monitoring (Malacca, Sunda, Lombok)',
      'IHSG & Indonesian market indicators',
      'Natuna & South China Sea maritime security',
      'Critical undersea cable & energy infrastructure',
      'Situation analysis & regional threat intelligence',
    ],
  },
  tech: {
